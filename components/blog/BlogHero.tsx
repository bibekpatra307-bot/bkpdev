  ...
  return (
    <section className="relative pt-16 md:pt-32 pb-10 md:pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-[#0a0f1c]">
      ...
      <div className="max-w-4xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        >
          Insights, News <br />
          <span className="text-primary-500">& Tech Trends</span>
        </motion.h1>
        ...
        >
          Stay updated with the latest in technology, software development, design, and digital marketing strategies.
        </motion.p>
      </div>
    </section>
  );
