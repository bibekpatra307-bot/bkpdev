      ...
      <div className="max-w-7xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-primary-900 to-primary-700 rounded-3xl p-5 md:p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 relative overflow-hidden">
          ...
          <div className="relative z-10 w-full md:w-auto shrink-0 flex justify-center md:justify-end">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-4 md:px-8 py-2 md:py-4 text-sm md:text-base font-semibold text-primary-900 bg-white rounded-full hover:bg-primary-50 hover:scale-105 transition-all duration-300 shadow-lg whitespace-nowrap"
            >
              Get In Touch
