    ...
    <section className="py-12 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-16">
          <p className="text-xs md:text-sm font-bold text-primary-600 tracking-wider uppercase mb-3">OUR CORE VALUES</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-8">
          {values.map((value, index) => (
            ...
            >
              <div className="w-20 h-20 mx-auto rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-primary-600 mb-3 md:mb-6 shadow-sm group-hover:bg-primary-600 group-hover:text-white transition-all duration-300">
                {value.icon}
              </div>
