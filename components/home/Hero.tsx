...
export default function Hero() {
  return (
    <section className="relative md:min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#0a0a0e] pt-12 pb-12 md:pt-28 md:pb-32">
      <HeroVisual />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-6 flex flex-col items-center text-center mt-8">
        ...
        >
          ...
          <motion.div
            ...
            className="w-full mt-8 mb-10 md:mt-12 md:mb-16 relative z-50"
          >
             <HeroSearch />
          </motion.div>
        </motion.div>
