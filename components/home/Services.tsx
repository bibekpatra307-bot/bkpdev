    ...
    <section className="py-12 md:py-24 bg-white relative">
      <div className="max-w-7xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 md:mb-16">
          <p className="text-xs md:text-sm font-bold text-primary-600 tracking-wider uppercase mb-3">Our Services</p>
          <h2 className="text-2xl md:text-3xl md:text-4xl font-heading font-bold text-slate-900 mb-2 md:mb-4">
          ...
          {services.map((service, index) => (
            ...
            >
              <Link href={service.path} className="block group">
                <div className="h-full bg-white border border-slate-200 rounded-2xl p-4 md:p-8 hover:shadow-xl hover:border-primary-100 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                  ...
                  <div className={`w-16 h-16 rounded-xl ${service.bgColor} ${service.color} flex items-center justify-center mb-3 md:mb-6 relative z-10 group-hover:scale-110 transition-transform duration-300`}>
                    {service.icon}
                  </div>
