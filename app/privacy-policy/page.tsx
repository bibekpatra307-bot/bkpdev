    ...
    <>
      ...
      <section className="py-12 md:py-24 bg-white relative -mt-10">
        <div className="max-w-3xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8 text-slate-600 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">1. Introduction</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">2. The Data We Collect About You</h2>
          <p>We may collect, use, store and transfer different kinds of personal data about you which we have grouped together as follows:</p>
          <ul className="list-disc pl-3 md:pl-6 space-y-2">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">3. How We Use Your Personal Data</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">4. Data Security</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">5. Contact Us</h2>
