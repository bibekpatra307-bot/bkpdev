    ...
    <>
      ...
      <section className="py-12 md:py-24 bg-white relative -mt-10">
        <div className="max-w-3xl mx-auto px-2 md:px-4 sm:px-6 lg:px-8 text-slate-600 leading-relaxed space-y-6">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">1. Agreement to Terms</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">2. Intellectual Property Rights</h2>
          <p>Unless otherwise indicated, the Site is our proprietary property and all source code, databases, functionality, software, website designs, audio, video, text, photographs, and graphics on the Site (collectively, the "Content") and the trademarks, service marks, and logos contained therein (the "Marks") are owned or controlled by us or licensed to us, and are protected by copyright and trademark laws.</p>

          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">3. User Representations</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">4. Prohibited Activities</h2>
          <p>You may not access or use the Site for any purpose other than that for which we make the Site available. The Site may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.</p>

          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">5. Modifications and Interruptions</h2>
          ...
          <h2 className="text-xl md:text-2xl font-bold text-slate-900 mt-5 md:mt-10 mb-2 md:mb-4">6. Contact Us</h2>
